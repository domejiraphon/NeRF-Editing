...
def main_seq(mesh_path, tet_path, deformed_paths, check_output=False):
    ...
    tet_ids, barys = batchify(mesh_verts, tet_mesh, chunk=30)
...
def batchify(verts, tet_mesh, chunk=100):
    ...
    for i in range(0, verts.shape[0], chunk):
        print(f"quering {i}/{verts.shape[0]}...")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mesh_path', type=str, default="../runs/horse/mesh/model.obj")
    parser.add_argument('--tet_path', type=str, default="../runs/horse/mesh/model_.txt")
    parser.add_argument('--deformed_path', type=str, default="../runs/horse/mesh_seq/*.obj")
    args = parser.parse_args()
    # mesh_path = "../runs/horse/mesh/model.obj"
    # tet_path = "../runs/horse/mesh/model_.txt"
    # deformed_dir = "../runs/horse/mesh_seq/*.obj"

    deformed_paths = sorted(glob.glob(args.deformed_path))[-1:]
    main_seq(args.mesh_path, args.tet_path, deformed_paths)